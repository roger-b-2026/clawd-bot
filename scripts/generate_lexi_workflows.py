...
with open("models/lexi_fairfax/lexi_prompts_detailed.md") as f:
    content = f.read()
...
for i, (title, prompt) in enumerate(prompts):
    ...
    with open(f"user/default/workflows/lexi_{i:03d}_{lane}.json", "w") as f:
        json.dump(workflow, f, indent=2)
    print(f"  Generated: {title[:40]}")

print(f"\nGenerated {len(prompts)} Lexi workflows in user/default/workflows/")
